error id: file:///C:/Users/JHONATAN/OneDrive/Escritorio/DESARROLLO%20WEB/PROYECTO-FINAL/versiones/v1.1.7/backend/venta-camaras-seguridad/src/main/java/com/ventacamaras/camaras/service/ClienteService.java:java/lang/IllegalArgumentException#
...
public class ClienteService {
    ...
    public Cliente crearCliente(Cliente cliente) {
        if (clienteRepository.findByEmail(cliente.getEmail()).isPresent()) {
            throw new Illega@@lArgumentException("El email ya está registrado");
        }
